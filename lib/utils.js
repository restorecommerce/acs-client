...
exports.convertDBUser = (user) => __awaiter(void 0, void 0, void 0, function* () {
    const defaultScope = user.default_scope || undefined;
    let scope;
    if (defaultScope) {
        scope = yield exports.reduceRoleAssociations(user.role_associations, defaultScope);
    }
