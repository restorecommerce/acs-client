...
class ACSAuthZ {
     ...
     * @param resource
     */
    isAllowed(request, hierarchicalScope) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (request.target.action == 'MODIFY' || request.target.action == 'DELETE') {
                resources = yield cache_1.getOrFill(resources, (res) => __awaiter(this, void 0, void 0, function* () {
                    return this.getResourcesWithMetadata(resources);
                }), cachePrefix + ':getResourcesWithMetadata');
            }
            if (!hierarchicalScope) {
                hierarchicalScope = yield cache_1.getOrFill(subject.role_associations, (role_associations) => __awaiter(this, void 0, void 0, function* () {
     ...
     * @param resources
     */
    getResourcesWithMetadata(resources) {
        return __awaiter(this, void 0, void 0, function* () {
            const ids = [];
            let entity;
            ...
            if (!_.isEmpty(ids)) {
                const grpcConfig = config_1.cfg.get(`client:${entity}`);
                if (grpcConfig) {
    ...
    * @param resource
    */
    whatIsAllowed(request, hierarchicalScope) {
        return __awaiter(this, void 0, void 0, function* () {
            const authZRequest = this.prepareRequest(request);
            authZRequest.context = {
                subject: {},
    ...
    createHierarchicalScopeTrees(roleAssociations) {
        return __awaiter(this, void 0, void 0, function* () {
            const ids = new Set();
